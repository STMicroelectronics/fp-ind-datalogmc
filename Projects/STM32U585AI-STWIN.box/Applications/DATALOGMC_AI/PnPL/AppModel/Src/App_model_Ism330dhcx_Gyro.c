...
uint8_t ism330dhcx_gyro_comp_init(void)
{
  ...
  ism330dhcx_gyro_set_sensor_annotation("\0");
  ism330dhcx_gyro_set_odr(pnpl_ism330dhcx_gyro_odr_hz6667);
  ism330dhcx_gyro_set_fs(pnpl_ism330dhcx_gyro_fs_dps4000);
  ism330dhcx_gyro_set_enable(true);
...
uint8_t ism330dhcx_gyro_set_odr(pnpl_ism330dhcx_gyro_odr_t enum_id)
{
...
uint8_t ism330dhcx_gyro_set_fs(pnpl_ism330dhcx_gyro_fs_t enum_id)
{
  uint8_t ret = PNPL_NO_ERROR_CODE;
  float value;
  switch (enum_id)
