...
#define SYS_MCP_TASK_BASE_ERROR_CODE                          SYS_BCP_BASE_ERROR_CODE + SYS_GROUP_ERROR_COUNT
#define SYS_MCP_TASK_INIT_ERROR_CODE                          SYS_MCP_TASK_BASE_ERROR_CODE + 1
#define SYS_MCP_TASK_MSG_LOST_ERROR_CODE                      SYS_MCP_TASK_BASE_ERROR_CODE + 2
