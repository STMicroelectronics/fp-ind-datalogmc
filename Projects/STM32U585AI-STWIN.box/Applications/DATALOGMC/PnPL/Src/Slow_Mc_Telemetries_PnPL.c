...
#include "Slow_Mc_Telemetries_PnPL_vtbl.h"
...
uint8_t Slow_Mc_Telemetries_PnPL_vtblGetStatus(IPnPLComponent_t *_this, char **serializedJSON, uint32_t *size, uint8_t pretty)
{
  JSON_Value *tempJSON;
  ...
  field (this is :actuators). ONLY for Sensors, Algorithms and Actuators */
...
uint8_t Slow_Mc_Telemetries_PnPL_vtblSetProperty(IPnPLComponent_t *_this, char *serializedJSON, char **response, uint32_t *size, uint8_t pretty)
{
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream.temperature.enable"))
    {
      ...
      ret = slow_mc_telemetries_set_st_ble_stream__temperature_enable(st_ble_stream);
      if(ret == 0)
      {
      ...
      {
        json_object_dotset_string(respJSONObject, "slow_mc_telemetries.st_ble_stream.temperature.enable.value", "PNPL_SET_ERROR");
      }
    }
  }
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    ...
    {
      const char * st_ble_stream =json_object_dotget_string(tempJSONObject, "slow_mc_telemetries.st_ble_stream.temperature.unit");
      ret = slow_mc_telemetries_set_st_ble_stream__temperature_unit(st_ble_stream);
      if(ret == 0)
      {
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    ...
    {
      const char * st_ble_stream =json_object_dotget_string(tempJSONObject, "slow_mc_telemetries.st_ble_stream.temperature.format");
      ret = slow_mc_telemetries_set_st_ble_stream__temperature_format(st_ble_stream);
      if(ret == 0)
      {
      ...
      {
        json_object_dotset_string(respJSONObject, "slow_mc_telemetries.st_ble_stream.temperature.format.value", "PNPL_SET_ERROR");
      }
    }
  }
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream.ref_speed.enable"))
    {
      ...
      ret = slow_mc_telemetries_set_st_ble_stream__ref_speed_enable(st_ble_stream);
      if(ret == 0)
      {
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    ...
    {
      const char * st_ble_stream =json_object_dotget_string(tempJSONObject, "slow_mc_telemetries.st_ble_stream.ref_speed.unit");
      ret = slow_mc_telemetries_set_st_ble_stream__ref_speed_unit(st_ble_stream);
      if(ret == 0)
      {
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    ...
    {
      const char * st_ble_stream =json_object_dotget_string(tempJSONObject, "slow_mc_telemetries.st_ble_stream.ref_speed.format");
      ret = slow_mc_telemetries_set_st_ble_stream__ref_speed_format(st_ble_stream);
      if(ret == 0)
      {
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream.speed.enable"))
    {
      ...
      ret = slow_mc_telemetries_set_st_ble_stream__speed_enable(st_ble_stream);
      if(ret == 0)
      {
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream.speed.unit"))
    {
      ...
      ret = slow_mc_telemetries_set_st_ble_stream__speed_unit(st_ble_stream);
      if(ret == 0)
      {
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream.speed.format"))
    {
      ...
      ret = slow_mc_telemetries_set_st_ble_stream__speed_format(st_ble_stream);
      if(ret == 0)
      {
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream.bus_voltage.enable"))
    {
      ...
      ret = slow_mc_telemetries_set_st_ble_stream__bus_voltage_enable(st_ble_stream);
      if(ret == 0)
      {
      ...
      {
        json_object_dotset_string(respJSONObject, "slow_mc_telemetries.st_ble_stream.bus_voltage.enable.value", "PNPL_SET_ERROR");
      }
    }
  }
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    ...
    {
      const char * st_ble_stream =json_object_dotget_string(tempJSONObject, "slow_mc_telemetries.st_ble_stream.bus_voltage.unit");
      ret = slow_mc_telemetries_set_st_ble_stream__bus_voltage_unit(st_ble_stream);
      if(ret == 0)
      {
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    ...
    {
      const char * st_ble_stream =json_object_dotget_string(tempJSONObject, "slow_mc_telemetries.st_ble_stream.bus_voltage.format");
      ret = slow_mc_telemetries_set_st_ble_stream__bus_voltage_format(st_ble_stream);
      if(ret == 0)
      {
      ...
      {
        json_object_dotset_string(respJSONObject, "slow_mc_telemetries.st_ble_stream.bus_voltage.format.value", "PNPL_SET_ERROR");
      }
    }
  }
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream.fault.enable"))
    {
      ...
      ret = slow_mc_telemetries_set_st_ble_stream__fault_enable(st_ble_stream);
      if(ret == 0)
      {
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream.fault.unit"))
    {
      ...
      ret = slow_mc_telemetries_set_st_ble_stream__fault_unit(st_ble_stream);
      if(ret == 0)
      {
  ...
  if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream"))
  {
    if (json_object_dothas_value(tempJSONObject, "slow_mc_telemetries.st_ble_stream.fault.format"))
    {
      ...
      ret = slow_mc_telemetries_set_st_ble_stream__fault_format(st_ble_stream);
      if(ret == 0)
      {
...
uint8_t Slow_Mc_Telemetries_PnPL_vtblExecuteFunction(IPnPLComponent_t *_this, char *serializedJSON, char **response, uint32_t *size, uint8_t pretty)
{
  return 1;
}
