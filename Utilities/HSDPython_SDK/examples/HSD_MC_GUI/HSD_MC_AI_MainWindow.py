...
import st_dtdl_gui.UI.images
import HSD_MC_GUI.UI.images

from pkg_resources import resource_filename
motor_recovery_img_path = resource_filename('HSD_MC_GUI.UI.images', 'Recovery_Status.png')
motor_normal_img_path = resource_filename('HSD_MC_GUI.UI.images', 'Motor_Normal_Class.png')
motor_anomaly_img_path = resource_filename('HSD_MC_GUI.UI.images', 'Motor_Anomaly_Class.png')
motor_vibration_img_path = resource_filename('HSD_MC_GUI.UI.images', 'Motor_Vibration_Class.png')
motor_magnet_img_path = resource_filename('HSD_MC_GUI.UI.images', 'Motor_Magnet_Class.png')
motor_belt_img_path = resource_filename('HSD_MC_GUI.UI.images', 'Motor_Belt_Class.png')
...
motor_bearing_img_path = resource_filename('HSD_MC_GUI.UI.images', 'Motor_Bearing_Class.png')
